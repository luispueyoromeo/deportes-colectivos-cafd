  ...
  return `
    <section class="page-section">
      ${pageIntro(
        ...
        'Filtra los recursos por deporte, bloque de contenido, formato y curso académico. Los ejemplos incluidos son editables para facilitar la actualización manual de enlaces a Google Drive.',
      )}
      <div class="filters" aria-label="Filtros del repositorio">
        ...
        ${selectFilter('Bloque', 'block', ['Todos', ...blockFilterOptions], (value) => value)}
        ${selectFilter('Formato', 'format', ['Todos', ...formats], (value) => value)}
        ${selectFilter('Curso académico', 'academicYear', ['Todos', ...academicYears], (value) =>
          value === 'Todos' ? 'Todos los cursos' : value,
        )}
      </div>
...
function renderSportPage(sport) {
  ...
  return `
    <section class="page-section">
      ...
      <div class="filters sport-year-filter" aria-label="Filtro por curso académico">
        ${selectFilter('Curso académico', 'academicYear', ['Todos', ...academicYears], (value) =>
          value === 'Todos' ? 'Todos los cursos' : value,
        )}
      </div>
